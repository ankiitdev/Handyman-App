...
public class Forgot_hpass_verify extends AppCompatActivity {
String otp_hman;
EditText et_otp;
String mobile;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forgot_hpass_verify);
    ...
    {
        Intent intent=new Intent(Forgot_hpass_verify.this,Forgot_hpass.class);
    ...
    {
        //Intent i=new Intent(Forgot_hpass_verify.this,Forgot_hpass_cp.class);
