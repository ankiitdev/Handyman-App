...
public class Forgot_cpass extends AppCompatActivity {
    MSG91 msg91;
    CaptchaGenerator cg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forgot_cpass);
    ...
    public void nex(View view)
    {
        ...
        else
        {
            ...
            Intent intent=new Intent(Forgot_cpass.this,Forgot_cpass_verify.class);
            intent.putExtra("OTP_HMAN",otp);
            intent.putExtra("MOBILE",mnumber);
            startActivity(intent);
            finish();
